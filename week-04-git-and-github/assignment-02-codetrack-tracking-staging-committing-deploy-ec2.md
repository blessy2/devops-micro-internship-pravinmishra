...
![init2](screenshots/pwd.jpg)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![init2](screenshots/status.jpg)
...
![init2](screenshots/index.jpg)
![init2](screenshots/style.jpg)
...
![init2](screenshots/status1.jpg)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![init2](screenshots/status2.jpg)
...
![init2](screenshots/commit1.jpg)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![init2](screenshots/log1.jpg)
...
![init2](screenshots/changeindex.jpg)
![init2](screenshots/live.jpg)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![init2](screenshots/status3.jpg)

---

#### Screenshot 11 — Output of `git commit`

![init2](screenshots/commit2.jpg)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![init2](screenshots/log2.jpg)
...
`https://www.linkedin.com/posts/blessy-s-06b379269_dmibypravinmishra-devops-agenticai-share-7486095221529759744-mxM7/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEG6aBMB0zfBR9hQTWrl7i6zZCygzNyvY74`

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![init2](screenshots/link.jpg)
