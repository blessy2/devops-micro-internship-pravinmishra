...
![md2](screenshots/ass2_skill1.jpg)
![md2](screenshots/ass3_skill2.jpg)

---

#### Screenshot 3 — Screenshot 3 — `tf-plan/SKILL.md` frontmatter showing `allowed-tools: Bash, Read, Grep` (no Write) and `disable-model-invocation: true`

![md2](screenshots/ass3_planskil.jpg)
...
![md2](screenshots/ass3_tr1.jpg)

---

#### Screenshot 5 — VS Code sidebar showing the `terraform/` folder with all generated files inside

![md2](screenshots/ass3_tr2.jpg)
...
![md2](screenshots/ass3_tfplan.jpg)
...
`https://www.linkedin.com/posts/activity-7481050894013333504-DHvQ?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEG6aBMB0zfBR9hQTWrl7i6zZCygzNyvY74`
=======
