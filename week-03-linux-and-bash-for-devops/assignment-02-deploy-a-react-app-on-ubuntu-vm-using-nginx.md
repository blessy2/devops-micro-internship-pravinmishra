...
![login2](screenshots/app_edit.jpg)
...
![login2](screenshots/active.jpg)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![login2](screenshots/default.jpg)
...
![login2](screenshots/ifconfig.jpg)
